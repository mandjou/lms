...
import com.kofianan.lms.dashboard.web.rest.util.ResponseUtil;
...
public class UserResource {
	...
	public ResponseEntity<?> changeUserPassword(@RequestBody UserDTO userDTO){
		log.debug("REST request to reset password: {}", userDTO.getLogin());
		boolean status = userService.changeUserPassword(userDTO.getLogin(), userDTO.getPassword());
		final MappingJacksonValue response = new MappingJacksonValue(status);
		if (status) {
