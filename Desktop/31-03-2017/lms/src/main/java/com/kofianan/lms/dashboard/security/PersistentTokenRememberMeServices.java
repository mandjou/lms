package com.kofianan.lms.dashboard.security;
...
import com.kofianan.lms.dashboard.service.util.RandomUtil;
...
public class PersistentTokenRememberMeServices extends AbstractRememberMeServices {
    ...
    public PersistentTokenRememberMeServices(LmsProperties lmsProperties,
            org.springframework.security.core.userdetails.UserDetailsService userDetailsService,
            PersistentTokenRepository persistentTokenRepository, UserRepository userRepository) {

        super(lmsProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
