...
public class MailService {
    ...
    public MailService(LmsProperties lmsProperties, JavaMailSender javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom(lmsProperties.getMail().getFrom());
    ...
    public void sendActivationEmail(User user) {
        ...
        context.setVariable(BASE_URL, lmsProperties.getMail().getBaseUrl());
